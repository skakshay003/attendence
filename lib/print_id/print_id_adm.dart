...
// ignore_for_file: prefer_const_constructors, prefer_const_literals_to_create_immutables, avoid_unnecessary_containers, sized_box_for_whitespace, avoid_print, depend_on_referenced_packages, unused_import, use_key_in_widget_constructors, file_names, use_build_context_synchronously, non_constant_identifier_names, camel_case_types
...
class printadm extends StatefulWidget {
  const printadm({Key? key}) : super(key: key);

  @override
  State<printadm> createState() => _printadmState();
}

class _printadmState extends State<printadm>
