...
class leave_status_adm extends StatefulWidget {
  const leave_status_adm({Key? key}) : super(key: key);

  @override
  State<leave_status_adm> createState() => _leave_status_admState();
}

class _leave_status_admState extends State<leave_status_adm>
  ...
  int _currentPageIndex = 0;
   ...
   Future<void> checkLoginStatus() async {
    ...
    var session1_user = sharedPreferences.getString('userdpt');
