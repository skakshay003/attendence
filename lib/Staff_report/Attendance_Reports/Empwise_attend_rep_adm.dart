...
import '../../config.dart';
import 'Empwise_attend_rep_emp.dart';

class Empwise_rep_1 extends StatefulWidget {
  const Empwise_rep_1({Key? key}) : super(key: key);

  @override
  State<Empwise_rep_1> createState() => _Empwise_rep_1State();
}

class _Empwise_rep_1State extends State<Empwise_rep_1>
  ...
  Future<void> checkLoginStatus() async {
    ...
    var session1_user = sharedPreferences.getString('dept');
