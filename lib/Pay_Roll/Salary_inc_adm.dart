// ignore_for_file: file_names, use_build_context_synchronously, non_constant_identifier_names, prefer_final_fields, unused_field, use_super_parameters
...
import 'Salary_inc_emp.dart';

class Salary_Inc_adm extends StatefulWidget {
  const Salary_Inc_adm({Key? key}) : super(key: key);

  @override
  State<Salary_Inc_adm> createState() => _Salary_Inc_admState();
}

class _Salary_Inc_admState extends State<Salary_Inc_adm>
                              ...
                              DataCell(
                                ...
                                onTap: () {
                                  ...
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => Salary_Inc_emp(
                                          id: id,
                                          name: name,
                                          branch: branch,
                                        )
